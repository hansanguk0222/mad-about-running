...
import { GarminConnectClient } from '@/service/garminconnectClient';

const getData = async () => {
  await GarminConnectClient.login();
  console.log('login ok');
  const data = await GarminConnectClient.getActivities();
  console.log(data);
};

// TODO. VO2Max 링 구현하기

export const TrainningSummary = async () => {
  await getData();
  return (
      ...
      <div className="flex">
        ...
        <div className="pl-4 border-r">
          ...
          <div className="flex text-sm justify-between">
            <div className="flex flex-col w-[100px] pb-4">
              <span>5km 기록</span>
        ...
        <div>
          <h3 className="text-md flex justify-center pb-4 pl-4">
            트레이닝 상태
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger className="pl-1">
